 ...
 */
TEST_F(CppADCGSolveTest, SolveAdd_2var_1bif) {
    this->verbose_ = true;
 ...
 */
TEST_F(CppADCGSolveTest, SolveAdd_2var_2bif) {
    this->verbose_ = true;
...
/**
 * @test 3 instances of the save variable with 3 bifurcations
 */
TEST_F(CppADCGSolveTest, SolveAdd_3var_3bif) {
    this->verbose_ = true;
